...
public class AppJwtUtil {
    ...
    // TOKEN的有效期
    private static final int TOKEN_TIME_OUT = 3_600; // 一天（S）
    //private static final long TOKEN_TIME_OUT = 30*60*1000L; //半小时
